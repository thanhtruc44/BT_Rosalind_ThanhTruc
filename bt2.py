...
for record in SeqIO.parse(fasta_file, 'fasta'):
    ...
    if len(sequences) == num_sequences:
        break
# Ghi lại quá trình đọc chuỗi từ tệp fasta
logging.info('Doc duoc {} chuoi tu tep fasta'.format(len(sequences)))
...
#Ghi lại quá trình tạo hàm profile_maxtrix thành công
logging.info('Tao ham profile_maxtrix thanh cong')
...
#Ghi lại quá trình tạo hàm consensus_strìng thành công
logging.info('Tao ham consensus_string thanh cong')
profile = profile_matrix(sequences)
logging.info('Da tinh toan profile matrix')
print(consensus_string(profile))
logging.info('Da tao consensus string')
